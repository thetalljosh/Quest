...
import type { StatName } from "@/shared/lib/constants";
...
/**
 * Returns stat point increments for completing a quest of the given type.
 */
export function distributeStatPoints(
  questType: QuestType
): Record<StatName, number> {
  return STAT_REWARDS[questType];
}
